...
import image from "../public/slideshow/image.jpg";
import image4 from "../public/slideshow/image4.png";
import imager from "../public/slideshow/imager.png";
...
export default function Home() {
  return (
    <main className = "bg-neutral-900">
      ...
      <section className = " mx-auto py-20 mt-18 text-neutral-100">
 ...
 {/*  <section className = "flex flex-wrap justify-center">
      <div className="w-full md:w-4/12 px-4 text-center ">
        <div className="relative flex flex-col min-w-0 break-words bg-white w-full shadow-lg rounded-lg md:-mt-32"> 
          <div className="px-4 pb-5 flex-auto">
            <h6 className="text-xlfont-semibold">
              Lorem, ipsum.
              </h6>
    ...
    <section className=" bg-neutral-800 rounded-lg shadow-slate-600 shadow-md flex mx-10 py-4 text-neutral-300">
      ...
      <div className = "mx-10 my-8">
            <h3 className="text-3xl mb-3 font-bold">Hiroki Itokazu</h3>
  ...
  <section className = "border-t-2 border-zinc-800 bg-gradient-to-b from-neutral-900 to-gray-700 flex justify-center py-14">
      <div className="w-full md:w-4/12 px-4 text-center ">
        <div className=" relative mb-5 shadow-md shadow-zinc-600 rounded-lg"> 
          <div className="px-4 pt-7 pb-5">
            <h6 className="text-xl font-semibold text-neutral-200">
              Lorem, ipsum.
              </h6>
    ...
    <section className = "bg-gray-700  px-20 ">
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-28">
        <div className=" p-5">
          <section>
          <h1 className = "font-semibold text-2xl lg:text-3xl border-b-2 border-neutral-300 text-white">Lorem ipsum dolor sit amet.</h1>
          ...
          <div className="rounded-lg bg-gray-200">
              <p>Insert Picture(s) here</p>
          </div>
        </div>
    </section>

    <section className = "bg-gradient-to-b py-20 from-gray-700  to-neutral-800">
      <div className = "bg-gradient-to-tr from-neutral-900 to-neutral-700 rounded-lg mx-32 grid grid-cols-1 lg:grid-cols-3 items-center shadow-md shadow-zinc-600 text-white">
          <section className = "lg:col-span-2 p-10">
            <h1 className = "lg:text-3xl text-2xl mb-6">Lorem ipsum dolor sit amet.</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis eveniet quia quam reprehenderit voluptas aliquid.</p>
          </section>
